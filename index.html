...
const authConfig = {
    "siteName": "Chizuru X Mars", // Website name
    ...
    "refresh_token": "1//0gQc6JrfGABQDCgYIARAAGBASNwF-L9IreU_ElVbpctz4_FcfOvGb7phbSLD1BslRjQOB4ZLD6pH-rkKilw9BHE0W06qRCutCsD8", // Authorize token
    ...
    "roots":[
      {
          ...
          "auth": {"zeeone171":"password"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "1tp93LhL0y6w3BdHjini4R45eVcTEkOM8",
          "name": "Cloud",
          "protect_file_link": false,
          "auth": {"zeeone171":"password", "username171":"password1"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0ANVFTrSl4Mo_Uk9PVA",
          "name": "Cloud",
          "protect_file_link": false,
          "auth": {"zeeone171":"password", "username171":"password1"} /* Remove double slash before "auth" to activate id password protection */
      },
...
const uiConfig = {
    ...
    "nav_link_4": "Donasi", // change navigation link name
    ...
    "contact_link": "https://trakteer.id/royalemars/tip", // Link to Contact Button on Menu
